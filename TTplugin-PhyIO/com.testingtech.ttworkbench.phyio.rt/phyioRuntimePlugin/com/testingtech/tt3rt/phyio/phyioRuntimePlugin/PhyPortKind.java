...
public enum PhyPortKind {
	...
	// fixed
	PhyConfig(GeneralConfig01), PhyLED(LED01), PhyEcho(PingEcho01), PhyMotor(Motor01), PhyColorSensor(ColorView01), PhyRelay(Relay01), PhyLightSensor(LightSensor01), RFIDSensor(RFIDSensor01);
